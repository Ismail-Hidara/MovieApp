...
public class MangaService {
    ...
    public MangaService(WebClient.Builder builder) {
        this.webClient = builder.baseUrl("https://graphql.anilist.co").build();
    }

    public String getTrendingManga(int page, int perPage, String genre, String format) {
        String query = """
            query ($page: Int, $perPage: Int, $genre: String, $format: MediaFormat) {
              Page(page: $page, perPage: $perPage) {
                media(type: MANGA, genre: $genre, format: $format, sort: TRENDING_DESC) {
                  id
    ...
    public String getMangaDetails(int id) {
        String query = """
            query ($id: Int) {
